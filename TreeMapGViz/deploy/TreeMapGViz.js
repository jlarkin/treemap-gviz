...
TreeMapGViz.prototype.loadOptions = function(){
    try{    
		...
		if (this.options != null && this.options.getInt != null){
            ...
            if (this.options.getInt('labels')==1)
                o.labelsOnTopSize = 16;
			...
			if (this.options.getInt('layout')==1){
				//3d
				o.borderWidth = 2;
				o.borderExtrueAmount = 0.25;
			}else{
				//flat
                o.borderWidth = 1;
                o.borderExtrueAmount = 0;
			}
		}
...
TreeMapGViz.gadgetInit = function(){
	...
	var queryResponseHandler = function(){
		try{
	        var dt = res.getDataTable();
			var tmg = new TreeMapGViz(content_div);
 ...
 * @private
 */
TreeMapGViz.debugInit = function(enable,contentDiv){
	try{
